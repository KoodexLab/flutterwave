...
<html>
    ...
    <body class="stripe-pg">
        ...
        <?php $no_cards = 0; if($page_type == "PAYMENT_LIST" && count($userPaymentInfoData) > 0) { ?>
        ...
        <div class="container py-4 custom-scroll-div">
            ...
            <div class="row justify-content-center custom-mt-header add-card-form">
                ...
                <?php $supported_cards = array('visa','mastercard','jcb','amex','discover','dinersclub','unionpay'); $has_card = 0; ?>
